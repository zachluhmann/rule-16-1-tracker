...
| Rule 16.1 is "the first MDL-specific Federal Rule" | **index.html (public)** | ✅ **VERIFIED 2026-08-12** against two independent secondary sources: National Law Review, *First-Ever Procedural Rule Issued for MDLs* ("This is the first MDL-specific rule and is the culmination of a multiyear-long rulemaking process"), and K&L Gates, *FRCP 16.1 Arrives* (Jan. 6, 2026) ("the first formal procedural framework tailored to multidistrict litigation"). Still secondary; confirm against the rulemaking record before the submission goes. |
| Rule 16.1 "does not impose mandatory obligations on transferee courts"; its "effectiveness will ultimately depend on whether the transferee court chooses to enforce its provisions" | **index.html (public)** | ✅ **VERIFIED 2026-08-12** against K&L Gates, *FRCP 16.1 Arrives: Will MDL Courts Embrace Its Tools?* (Jan. 6, 2026). Quoted verbatim. |
| 158 MDL proceedings pending at year-end 2025 | **index.html (public)** | ✅ **VERIFIED 2026-08-12** against JPML, *Calendar Year Statistics* (as of Dec. 31, 2025): pie chart of pending MDLs by type totals 158. |
